...
The integration declares these Python requirements in `custom_components/varco/manifest.json`:

- `cryptography>=42.0.0`
- `aiortc==1.14.0`

Home Assistant installs declared custom integration requirements during setup.
